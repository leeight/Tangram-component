...
baidu.ui.carousel.Carousel = baidu.ui.createUI(function(opts) {
    ...
    // ui控件的类型 **必须**
    uiType: 'carousel',
    // 横竖向的排列方式，取值horizontal,vertical
    ...
    render: function(target) {
        var me = this;
        baidu.dom.insertHTML(me.renderMain(target || me.target), 
            'beforeEnd', me.getString());
    ...
    _resize: function() {
        var me = this,
            // 由pageSize决定长度的一方
            offset_x = me.axis[me.orientation].offsetSize, 
            // 直接设置成item长度的一方
            offset_y = me.axis['horizontal' == me.orientation ? 'vertical' : 'horizontal'].offsetSize,
            item = me.getItem(0);
        
        if (item && (me.getBody()[offset_x] < me.pageSize * item[offset_x] 
            || me.getBody()[offset_y] < item[offset_y])) {
     ...
     * @param {HTMLElement} ele 需要插入的item，只取ele的内容.
    ...
    removeItem: function(index) {
        ...
        if (item) {
            ...
            me.scrollIndex = (index == me.scrollIndex) ? 0 : 
                (index < me.scrollIndex ? me.scrollIndex - 1 : me.scrollIndex);
            me.totalCount--;
            me._resize();
        }
        return item;
    ...
    _scrollTo: function(index, scrollOffset) {
        ...
        if (item) {
            ...
            me.getBody()[me.axis[me.orientation].scroll] = 
                me[me.axis[me.orientation].offsetSize] * (index - scrollOffset);
